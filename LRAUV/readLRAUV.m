%% Import data from LRAUV file
opts = delimitedTextImportOptions("NumVariables", 17);
opts.DataLines = [2, Inf];
opts.Delimiter = ",";
opts.VariableNames = ["datetime", "EpochSeconds", "platform_battery_charge", "depth", "time_fix", "latitude_fix", "longitude_fix", "platform_average_current", "height_above_sea_floor", "latitude", "longitude", "fix_residual_percent_distance_traveled", "temperature", "salinity", "WetLabsBB2FL_Output650", "BPC1_reserve_battery_charge", "platform_battery_voltage"];
opts.SelectedVariableNames = ["datetime", "EpochSeconds", "depth", "time_fix", "latitude_fix", "longitude_fix", "latitude", "longitude", "temperature", "salinity", "WetLabsBB2FL_Output650"];
opts.VariableTypes = ["string", "double", "string", "double", "double", "double", "double", "string", "string", "double", "double", "string", "double", "double", "double", "string", "string"];
opts.ExtraColumnsRule = "ignore";
opts.EmptyLineRule = "read";
opts = setvaropts(opts, ["platform_battery_charge", "platform_average_current", "height_above_sea_floor", "fix_residual_percent_distance_traveled", "BPC1_reserve_battery_charge", "platform_battery_voltage"], "WhitespaceRule", "preserve");
